...
while (1)
{
    ...
    if ((now - last_print_tick) >= 500)
    {
        ...
        snprintf(uart_buf, sizeof(uart_buf),
                 ...
                 ((uint32_t)motor_current_duty * 100) / MOTOR_PWM_MAX);
        uart_print(uart_buf);
    }
