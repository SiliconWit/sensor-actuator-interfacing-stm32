...
5. **Configure TIM3:** Under Timers, enable TIM3 with a 100 ms period. Prescaler = 7199 (36 MHz / 7200 = 5 kHz), Counter Period = 499 (5000 / 500 = 10 Hz, i.e. 100 ms). Enable the update interrupt.
