...
<Steps>
1. **Create new project** for STM32F103C8T6 following the CubeMX and CubeIDE setup from [Lesson 1](/education/sensor-actuator-interfacing-stm32/gpio-digital-interfacing/#creating-a-new-project). Name the project `MultiSensorLogger`.
